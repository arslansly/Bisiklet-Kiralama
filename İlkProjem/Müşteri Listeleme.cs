...
namespace İlkProjem
{
    public partial class Form3 : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from musterı where id ='" + dataGridView1.CurrentRow.Cells["id"].Value.ToString() + "'", baglanti);
            try
            {
                komut.ExecuteNonQuery();
                baglanti.Close();
            ...
            {
                MessageBox.Show("Müşterinin Geçmişte Kiraladağı Bisikletler Var..");
            }
        }
